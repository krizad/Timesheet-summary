...
import { Terminal, LayoutDashboard, Table as TableIcon, Calendar, Sun, Moon, Github } from 'lucide-react';
        ...
        <footer className="w-full max-w-6xl mt-auto pt-12 pb-6 border-t border-slate-200 dark:border-slate-800 flex flex-col md:flex-row justify-between items-center gap-4 text-sm text-slate-500 dark:text-slate-400">
          ...
          <div className="flex items-center gap-4 md:gap-6">
            <a 
              ...
              className="hidden sm:inline-flex px-3 py-1 rounded-full text-xs font-medium bg-slate-100 dark:bg-slate-800 text-slate-500 dark:text-slate-400 hover:text-emerald-500 dark:hover:text-emerald-400 hover:bg-emerald-50 dark:hover:bg-emerald-900/20 transition-all"
            >
